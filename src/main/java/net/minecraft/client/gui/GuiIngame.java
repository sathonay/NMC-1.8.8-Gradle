...
public class GuiIngame extends Gui
{
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Object score : arraylist1)
        {
            ...
            String s = ScorePlayerTeam.formatPlayerName(scoreplayerteam, ((Score) score).getPlayerName()) + (NakoryClient.getInstance().getSettings().showRedNumberInScoreboard ? ": " + EnumChatFormatting.RED + ((Score) score).getScorePoints() : "");
        ...
        for (Object score1 : arraylist1)
        {
            ...
            if (NakoryClient.getInstance().getSettings().showRedNumberInScoreboard) {
