                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if (NakoryClient.getInstance().getSettings().renderChatBackground && !(this.mc.currentScreen instanceof GuiChat) 
                                		|| NakoryClient.getInstance().getSettings().renderChatBackgroundToggle && this.mc.currentScreen instanceof GuiChat) drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
