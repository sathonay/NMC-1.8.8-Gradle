...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.fontRendererObj = new FontRenderer(this.gameSettings, new ResourceLocation("nakory/font/ascii.png"), this.renderEngine, false);
        ...
        this.standardGalacticFontRenderer = new FontRenderer(this.gameSettings, new ResourceLocation("nakory/font/ascii_sga.png"), this.renderEngine, false);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Nakory Client 1.8.8");
    ...
    // TODO : I will test if it's working when i will comeback from my holydays.
    public int getLimitFramerate()
    {
    	...
    	return (this.theWorld == null && this.currentScreen != null) ? highestMonitorFrequency : this.gameSettings.limitFramerate;
    }

    public boolean isFramerateLimitBelowMax()
    {
        return !Display.isActive() ? true : ((float)this.getLimitFramerate() < GameSettings.Options.FRAMERATE_LIMIT.getValueMax());
    }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new ToggleSprintMovementInput(this.gameSettings);
